    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const orderData = {
                ...
                shipping_cost: 100,
                total_amount: checkoutTotal + 100,
                notes: isBuyNow ? 'buy-now-order' : null
            };
            ...
            if (res.ok) {
                ...
                router.push("/order-confirmation/".concat(data.order_id));
            } else {
...
_s(CheckoutPage, "GIk8o8V/92jrTCDvm1iAlwZglro=", false, function() {
    return [
...
//# sourceMappingURL=_b435f156._.js.map