...
function AdminOrders() {
    _s();
    const [orders, setOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]) // Type the state
    ;
    ...
    const fetchOrders = async ()=>{
        ...
        try {
            const url = filter === 'all' ? 'http://localhost:8000/api/admin/orders' : "http://localhost:8000/api/admin/orders?status=".concat(filter);
    ...
    const updateOrderStatus = async (orderId, status)=>{
        ...
        if (!token) return;
        try {
            const res = await fetch("http://localhost:8000/api/admin/orders/".concat(orderId, "/status"), {
                method: 'PUT',
                headers: {
                    'Authorization': "Bearer ".concat(token),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                'cancelled'
                                    ...
                                    className: "px-4 py-2 rounded-lg capitalize ".concat(filter === status ? 'bg-blue-600 text-white' : 'bg-[#1a1d2e] text-gray-400 hover:text-white'),
                                    children: status
                                }, status, false, {
                                    fileName: "[project]/app/admin/orders/page.tsx",
                                    lineNumber: 117,
                                    ...
                                    children: orders.length > 0 ? orders.map((order)=>{
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "py-4 px-4 text-white",
                                                    children: ((_order_shipping_address = order.shipping_address) === null || _order_shipping_address === void 0 ? void 0 : _order_shipping_address.full_name) || 'N/A'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/admin/orders/page.tsx",
                                                    lineNumber: 155,
                                                    columnNumber: 23
...
_s(AdminOrders, "WOE7WDQsaLjAH1WRcd1y6P7Sh6s=");
_c = AdminOrders;
var _c;
...
//# sourceMappingURL=_9d5e27aa._.js.map