...
function EditProduct(param) {
    ...
    const fetchProduct = async ()=>{
        try {
            ...
            if (res.ok) {
                var _data_price, _data_stock, _data_images;
                const data = await res.json();
                setProduct(data);
                setFormData({
                    name: data.name || '',
                    description: data.description || '',
                    price: ((_data_price = data.price) === null || _data_price === void 0 ? void 0 : _data_price.toString()) || '',
                    category: data.category || 'men',
                    brand: data.brand || '',
                    stock: ((_data_stock = data.stock) === null || _data_stock === void 0 ? void 0 : _data_stock.toString()) || '',
                    images: ((_data_images = data.images) === null || _data_images === void 0 ? void 0 : _data_images.length) > 0 ? data.images : [
                        ''
                    ],
...
//# sourceMappingURL=_d04a492b._.js.map